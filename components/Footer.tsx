  ...
  return (
    <footer className="bg-slate-950 text-gray-300 p-4">
      <div className="flex justify-between items-center text-xs px-4">
        <div>
          <h3 className="font-bold text-white mb-2 text-sm">Contact Details</h3>
        ...
        <div className="flex items-center space-x-4">
          ...
          <a href="#" target="_blank" rel="noopener noreferrer" title="GitHub" className="hover:text-white transition-colors">
            <GithubIcon />
          </a>
        </div>
      </div>
